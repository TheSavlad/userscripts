...
// @ts-check
/** @type {any} */ (window).ozon.orderlist = (function () {
  /**
  ...
  function parseOrderDate(row, order) {
    ...
    const dateClass = order.state === ORDER_STATE_READY ? ".u4e_14" : ".ew4_14";
  ...
  return function () {
    ...
    ozon.observe(header, { attributes: true }, () => onHeader(header, orders));
